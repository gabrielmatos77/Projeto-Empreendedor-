...
export function RegisterMachine() {
  ...
  return <div className="w-full h-full flex justify-center items-center formanimated">
    <form
      ...
      <div className="firstdiv flex flex-col">
        <label>
          Primeiro Digite O Nome Da Maquina:
        </label>
        <input id="firstfield" name="name" required type="text" className="border bg-transparent p-2 rounded-md focus:outline-none" />
      </div>

      <div className="seconddiv flex flex-col">
        <label>
          Primeiro Digite O Nome Da Maquina:
        </label>
        <input id="secondfield" name="ip" required type="text" className="border bg-transparent p-2 rounded-md focus:outline-none" />
      </div>
